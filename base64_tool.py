...
class Base64Tool(QWidget):
    ...
    def init_ui(self):
        ...
        img_to_b64_layout.addWidget(self.img_preview)
        ...
        img_to_b64_layout.addWidget(self.b64_output)
        ...
        b64_to_img_layout.addWidget(self.b64_input)
        ...
        b64_to_img_layout.addWidget(self.decoded_preview)
