...
def process_single_image(
    ...
    try:
        with Image.open(input_path) as img:
            ...
            output_filename = f"{input_path_obj.stem}_resized.{output_ext}"
            unique_filename = get_unique_filename(str(output_dir_path), output_filename)
            output_path = output_dir_path / unique_filename
